...
- **Open**: Allow users to drag and drop tasks to change their status and re-order them in a column
...
- [patterns.dev](https://www.patterns.dev/) - Great site to learn more about react design patterns.
